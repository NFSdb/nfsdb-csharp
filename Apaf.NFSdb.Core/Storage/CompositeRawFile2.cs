...
{
    public class CompositeRawFile2 : IRawFile
    {
        ...
        public CompositeRawFile2(string fileName,
            int bitHint,
        ...
        public unsafe void ReadBytes(long offset, byte* array, int sizeBytes)
        {
            ...
            var readSize1 = Math.Min((int)(buff1.BufferSize + buff1.BufferOffset - offset),
                sizeBytes);
            buff1.ReadBytes(offset, array, readSize1);
            ...
            if (readSize1 < sizeBytes)
            {
                ...
                // Recursivly read.
                ReadBytes(offset, array, sizeBytes);
            }
        }
        ...
        public unsafe void WriteBytes(long offset, byte* array, int sizeBytes)
        {
            ...
            var writeSize = Math.Min((int)(buff1.BufferSize + buff1.BufferOffset - offset),
                sizeBytes);
            buff1.WriteBytes(offset, array, writeSize);
            ...
            if (writeSize < sizeBytes)
            {
                ...
                // Recursivly read.
                WriteBytes(offset, array, sizeBytes);
            }
        }
        ...
        {
            return "CompositeRawFile2: " + Filename;
        }
